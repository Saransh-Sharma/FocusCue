...
class NotchSettings {
    ...
    private let deepgramKeychain = KeychainStore(service: "FocusCue", account: "DeepgramAPIKey")
    private let openaiKeychain = KeychainStore(service: "FocusCue", account: "OpenAIAPIKey")
