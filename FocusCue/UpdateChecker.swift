...
class UpdateChecker {
    ...
    private let repoOwner = "saransh1337"
    private let repoName = "FocusCue"
    ...
    private func showUpdateAvailable(latestVersion: String, releaseURL: String) {
        ...
        alert.informativeText = "FocusCue \(latestVersion) is available. You are currently running \(currentVersion)."
    ...
    private func showUpToDate() {
        ...
        alert.informativeText = "FocusCue \(currentVersion) is the latest version."
        alert.alertStyle = .informational
